-- V9__create_outbox_events_table.sql
-- Migration #9: create table outbox_events

-- Creating table a universal Outbox table 'outbox_events' for all event types related to the CreditCard entity.
...
CREATE TABLE IF NOT EXISTS outbox_events (
    id UUID PRIMARY KEY,
    aggregate_type VARCHAR(50) NOT NULL,    -- Entity type (e.g., 'CreditCard')
    aggregate_id VARCHAR(255) NOT NULL,     -- Entity ID (card_id)
    event_type VARCHAR(100) NOT NULL,       -- Event name (e.g., 'CardCreated')
