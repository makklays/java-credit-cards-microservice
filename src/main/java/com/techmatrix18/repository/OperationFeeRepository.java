...
/**
 * Repository interface for OperationFee entities.
 *
 ...
 */
@Repository
public interface OperationFeeRepository extends ReactiveCrudRepository<OperationFee, Long> {

    Mono<OperationFee> findByOperationType(String operationType);
}
